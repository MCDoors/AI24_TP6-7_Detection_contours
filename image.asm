...
init_registres:				; Q3.2
		...
		movzx r9, dword ptr[rsp + 40]	; On stocke dans le registre r9, l'adresse du pixel de img_temp2 dans lequel on veut stocker le résultat. ATTENTION les contours ne sont pas comptés (32 de shadow space + 8 pour être au dessus de img_temp2
...
valeur_absolue_Gx:
		...
		cmp r15, 0		; Si c'est positif...
		jge calcul_Gy	; ... alors pas besoin de multiplier par -1
		imul r15, -1
...
G_negatif:
		...
		cmp r14, 0
		jge image_resultante ; Sinon on stocke dans le pixel de destination
